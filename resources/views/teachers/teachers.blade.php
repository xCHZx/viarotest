...
<div class="card card-custom-shadow">
    ...
    <div class="card-body">
        ...
        <!-- Tabla para mostrar-->
        <div>
            <table class="table table-hover table-bordered dt"  id="teachers" class="display">
    ...
    @include('teachers.teachers-modals')
...
<script type="text/javascript" src="\js\teachers.js"></script>
